...
if "%1" == "all" (
	...
	gcc -o Solveur Solveur.o algorithme_naif.o algorithme_circulaire.o algorithme_couleur.o algorithme_AVL.o algorithme_graphe.o AVL.o bibliotheque.o Grille.o Solution.o entree_sortie.o circuit.o Graphe.o
